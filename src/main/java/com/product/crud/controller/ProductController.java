...
//
//        logger.info("createProduct API called with product name: {}", productDto.getP_name());
//        logger.info("Product creation request  sent to service layer : ");
...
//    }
    ...
    public ResponseEntity<ProductDto> updateproduct(@RequestBody ProductDto productDto, @PathVariable Long id){
       ...
       logger.info("Updading product and calling service method");
       return ResponseEntity.ok(productService.updateProduct(productDto, id));
    }
